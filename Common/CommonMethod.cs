...
namespace urbanBackend.Models.Helper
{
    public static class CommonMethod
    {
        ...
        public static bool IsValidDateFormat_yyyymmdd(string timeString)
        {
            DateTime dummyOutput;
            return DateTime.TryParseExact(timeString, "yyyy-MM-dd", CultureInfo.InvariantCulture, DateTimeStyles.None, out dummyOutput);
        }
        public static bool IsUSDateFormat_yyyymmdd(string timeString)
        {
            DateTime dummyOutput;
            return DateTime.TryParseExact(timeString, "MM-dd-yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out dummyOutput);
        }
